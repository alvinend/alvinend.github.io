...
/* harmony import */ var _components_style_color__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/style/color */ "./src/components/style/color.js");
/* harmony import */ var _components_PreviewCompatibleImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/PreviewCompatibleImage */ "./src/components/PreviewCompatibleImage.js");
...
var ContentWrapper = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "blog-post__ContentWrapper"
})(["position:relative;width:80%;margin:40px auto;& a{margin-top:30px;font-size:24px;color:", ";}"], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].red[500]);
var TagContainer = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "blog-post__TagContainer"
})(["display:flex;flex-wrap:wrap;margin:40px 0;border-top:3px solid ", ";padding-top:30px;& > div{border:1px solid ", ";padding:4px 8px;border-radius:10px;line-height:1.2;margin-right:10px;}"], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].gray[400], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].gray[500]);
...
})(["padding-bottom:15px;border-bottom:3px solid ", ";margin-bottom:45px;font-size:24px;color:", ";"], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].gray[400], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].gray[600]);
var BlogTitle = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].h1.withConfig({
  displayName: "blog-post__BlogTitle"
})(["font-size:52px;color:", ";font-weight:900;line-height:1.2;"], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].red[600]);
var BodyContent = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].body.withConfig({
...
var ImageFrame = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "blog-post__ImageFrame"
})(["margin-bottom:45px;"]);
var HomeButton = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(gatsby__WEBPACK_IMPORTED_MODULE_3__["Link"]).withConfig({
  displayName: "blog-post__HomeButton"
})(["&&&{position:fixed;top:2%;right:5%;font-size:32px;color:white;border-radius:50%;padding:5px;background-color:", ";opacity:0.3;z-index:5;transition:all 0.5s;&:hover{opacity:1;}}"], _components_style_color__WEBPACK_IMPORTED_MODULE_7__["default"].gray[800]);
var BlogPostTemplate = function BlogPostTemplate(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_icons_io__WEBPACK_IMPORTED_MODULE_9__["IoIosHome"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 116
    },
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_PreviewCompatibleImage__WEBPACK_IMPORTED_MODULE_8__["default"], {
    imageInfo: {
      image: featuredimage,
...
var BlogPost = function BlogPost(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    helmet: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__["Helmet"], {
...
//# sourceMappingURL=cms.7f568ccf10898a3adeee.hot-update.js.map